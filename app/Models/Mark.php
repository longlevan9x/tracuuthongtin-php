...
class Mark extends Model
{
    ...
    {
        $this->coefficient1 = json_decode($this->coefficient1, JSON_NUMERIC_CHECK);
        $this->coefficient2 = json_decode($this->coefficient2, JSON_NUMERIC_CHECK);
        $this->mark_practice = json_decode($this->mark_practice, JSON_NUMERIC_CHECK);
