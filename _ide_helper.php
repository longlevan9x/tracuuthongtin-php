...
namespace App\Helpers\Facade { 
    ...
    class Helper {
         ...
         * @static 
         */ 
        public static function getMsv($msv, $number)
        {
            return \App\Helpers\Helper::getMsv($msv, $number);
        }
         ...
         * @static 
         */ 
        public static function getCaHocTrongNgay($tiet_hoc)
        {
            return \App\Helpers\Helper::getCaHocTrongNgay($tiet_hoc);
        }
         ...
         * @param string $format format == w -> 0 (for Sunday) through 6 (for Saturday)
         * format == N -> 1 (for Monday) through 7 (for Sunday)
         * @return false|string 
         * @static 
         */ 
        public static function getWeekInDay($day, $format = 'N')
        {
            return \App\Helpers\Helper::getWeekInDay($day, $format);
        }
         ...
         * @static 
         */ 
        public static function getFullTextualWeekInDay($day, $format = 'w')
        {
            return \App\Helpers\Helper::getFullTextualWeekInDay($day, $format);
        }
...
namespace App\Models\Facade { 
    ...
    class Student {
        ...
        {
            return \App\Models\Student::getAppends();
        }
        ...
        {
            return \App\Models\Student::getSemester();
        }
         ...
         * @static 
         */ 
        public static function syncStudentByDepartment($department_code)
        {
            return \App\Models\Student::syncStudentByDepartment($department_code);
        }
         ...
         * @static 
         */ 
        public static function syncStudent($msv)
        {
            return \App\Models\Student::syncStudent($msv);
        }
