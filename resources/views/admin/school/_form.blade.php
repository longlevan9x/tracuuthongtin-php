...
switch ($action) {
	case "edit":
		$form_title = __('abilities.school.resource.edit');
		break;
	case "index":
		$form_title = __('abilities.school.resource.create');
		break;
}
?>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                {{ Form::model(isset($model) ? $model : null, [
                    'url' => url('admin/school', [isset($model) ? $model->id : '']),
                    'files' => true,
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="code">@lang('admin/common.label.code')
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::text('code', $value = null,['class' => 'form-control col-md-7 col-xs-12', 'id' => 'code']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">@lang('admin/common.name') <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
